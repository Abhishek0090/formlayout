        ...
        <div  id="birla" class="data hide1 container" >
                            ...
                            <input type="text" class="form-control  "  name="toll_number" id="toll_number"  onchange="update_data('toll_number','toll_number')" >
                        </div>
                        <div class="col-md-6 aligninput form-group">
                                <span class="alphabet">c.</span>

                            <label for="">Toll free Fax</label>
                            <input type="text" class="form-control  "   name="toll_fax" id="toll_fax" onchange="update_data('toll_fax','toll_fax')" >
                            </div>
                        ...
                        <div class="col-md-6 aligninput">
                            ...
                            <input type="text" class="form-control  "  name="name_patient"  id="name_patient" onchange="update_data('name_patient','name_patient')">
                        </div>
                        <div class="col-md-6 aligninput">
                            <span class="alphabet">b.</span>
